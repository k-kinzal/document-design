import{n as e}from"./rolldown-runtime-DkW27tQK.js";import{o as t,s as n}from"./iframe-fR7HCL7S.js";var r,i,a,o,s,c;function l(){return(l=e((()=>{n(),r={title:`Foundations/Grid`,parameters:{docs:{description:{component:`Two frames, because there are two genres. The catalog frame is a fixed rail and a fluid column; the report sheet is twelve columns with a 24px gutter.`}}}},i={render:()=>t`
    ...
    <article class="sheet" style="padding-top:28px;padding-bottom:28px;position:relative">
      <div style="grid-column:1/-1;display:grid;grid-template-columns:subgrid;margin-bottom:24px">
        ${Array.from({length:12},(e,t)=>`<div style="grid-column:${t+1};background:var(--dd-blue-tint);border:1px solid var(--dd-blue);border-radius:3px;height:120px;display:flex;align-items:flex-end;justify-content:center;padding-bottom:6px;font-size:10px;color:var(--dd-blue);font-family:var(--dd-font-mono)">${t+1}</div>`).join(``)}
      </div>
    ...
    </div>`},c=[`CatalogFrame`,`SheetGrid`,`Subgrid`,`Breakpoints`],i.parameters={...i.parameters,docs:{...i.parameters?.docs,source:{originalSource:`{
  render: () => html\`
    <div class="doc" style="min-height:0;border:1px solid var(--dd-border)">
      <nav class="sidebar" style="height:auto;position:static;display:flex;align-items:center;justify-content:center">
        <code style="font-size:11px">260px · --dd-sidebar-width</code>
...
}`,...i.parameters?.docs?.source},description:{story:`The catalog frame. A 260px rail that does not move, and a column that takes
...
name clips, which makes the same sidebar look different on every screen.`,...i.parameters?.docs?.description}}},a.parameters={...a.parameters,docs:{...a.parameters?.docs,source:{originalSource:`{
  render: () => html\`
    <article class="sheet" style="padding-top:28px;padding-bottom:28px;position:relative">
      <div style="grid-column:1/-1;display:grid;grid-template-columns:subgrid;margin-bottom:24px">
        \${Array.from({
    length: 12
  }, (_, i) => \`<div style="grid-column:\${i + 1};background:var(--dd-blue-tint);border:1px solid var(--dd-blue);border-radius:3px;height:120px;display:flex;align-items:flex-end;justify-content:center;padding-bottom:6px;font-size:10px;color:var(--dd-blue);font-family:var(--dd-font-mono)">\${i + 1}</div>\`).join("")}
      </div>
      <section class="sec" style="margin-top:0">
        <div class="label">01<br>label</div>
        <div class="field">
...
}`,...a.parameters?.docs?.source},description:{story:`The report sheet. Twelve columns, 24px gutter, 1128px maximum.
...
margin rather than as a first column.`,...a.parameters?.docs?.description}}},o.parameters={...o.parameters,docs:{...o.parameters?.docs,source:{originalSource:`{
  render: () => html\`
    <article class="sheet" style="padding-top:28px;padding-bottom:28px">
      <section class="sec" style="margin-top:0">
        <div class="label">02<br>subgrid</div>
...
}`,...o.parameters?.docs?.source},description:{story:`Children use \`grid-template-columns: subgrid\` rather than a grid of their
...
divide the field into thirds, which are not the sheet's thirds.`,...o.parameters?.docs?.description}}},s.parameters={...s.parameters,docs:{...s.parameters?.docs,source:{originalSource:`{
  render: () => html\`
    <div class="definitions" style="max-width:640px">
      <div><dt><code>900px</code></dt><dd>The sidebar leaves the flow and opens over the page.
        It stays in the DOM in its reading order, so a screen reader and a keyboard
...
}`,...s.parameters?.docs?.source},description:{story:`Both frames fold at the same two points. Under 900px the rail leaves the
 flow; under 720px the sheet collapses to one column.`,...s.parameters?.docs?.description}}}})))()}l();export{s as Breakpoints,i as CatalogFrame,a as SheetGrid,o as Subgrid,c as __namedExportsOrder,r as default};