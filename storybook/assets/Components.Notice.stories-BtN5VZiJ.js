import{n as e}from"./rolldown-runtime-DkW27tQK.js";import{o as t,s as n}from"./iframe-fR7HCL7S.js";var r,i,a,o;function s(){return(s=e((()=>{n(),r={title:`Components/Notice`,parameters:{docs:{description:{component:`Something about the page that the page itself cannot show. Toned rather than variant-per-meaning; untoned it is a neutral aside, which is what most of them are.`}}}},i={render:()=>t`
    ...
    </main></div></div>`},o=[`Tones`,`WithList`],i.parameters={...i.parameters,docs:{...i.parameters?.docs,source:{originalSource:`{
  render: () => html\`
    <div class="doc"><div class="main"><main class="content">
      <div class="notice">
        <a href="#">812 statements</a> are lower bounds: a dependency, a cycle or a
...
}`,...a.parameters?.docs?.source}}}})))()}s();export{i as Tones,a as WithList,o as __namedExportsOrder,r as default};