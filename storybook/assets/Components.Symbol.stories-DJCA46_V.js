import{n as e}from"./rolldown-runtime-DkW27tQK.js";import{o as t,s as n}from"./iframe-fR7HCL7S.js";var r,i,a,o,s;function c(){return(c=e((()=>{n(),r={title:`Components/Symbol`,parameters:{docs:{description:{component:`A declared thing and its members — the shape an API reference is made of. A signature is read for its shape, so it is not wrapped: the indentation of a long parameter list is what makes it legible.`}}}},i={render:()=>t`
      ...
      <pre class="signature"><span class="t-key">interface</span> <span class="signature-name">QueryBuilder</span>
{
    ...
    </main></div></div>`},s=[`Head`,`Members`,`Types`],i.parameters={...i.parameters,docs:{...i.parameters?.docs,source:{originalSource:`{
  render: () => html\`
    <div class="doc"><div class="main"><main class="content">
      <div class="symbol-head">
        <h1><code>QueryBuilder</code><span class="chip tone-violet">interface</span></h1>
...
}`,...a.parameters?.docs?.source},description:{story:`A member that is not part of the surface is dimmed rather than hidden: a
 reader working out why a public method behaves as it does still needs to
 see that a private one exists.`,...a.parameters?.docs?.description}}},o.parameters={...o.parameters,docs:{...o.parameters?.docs,source:{originalSource:`{
  render: () => html\`
    <div class="doc"><div class="main"><main class="content">
      <pre class="signature"><span class="t-key">public function</span> <span class="signature-name">find</span>(
    <span class="t-name">Statement</span>|<span class="t-key">null</span> <span class="signature-param">$statement</span>,
...
}`,...o.parameters?.docs?.source},description:{story:`Type names are identity, so they take identity hues and never red.`,...o.parameters?.docs?.description}}}})))()}c();export{i as Head,a as Members,o as Types,s as __namedExportsOrder,r as default};