import{n as e}from"./rolldown-runtime-DkW27tQK.js";import{o as t,s as n}from"./iframe-fR7HCL7S.js";var r,i,a,o;function s(){return(s=e((()=>{n(),r={title:`Components/Callout`,parameters:{docs:{description:{component:`A paragraph that steps out of the flow to say something the surrounding text depends on.

Distinct from \`.notice\`, which is about the **page** — "this listing is filtered". A callout is about **the text it sits in**, so it lives inside prose and takes prose's measure.`}}}},i={render:()=>t`
    ...
    </article>`},o=[`Tones`,`MarginNote`],i.parameters={...i.parameters,docs:{...i.parameters?.docs,source:{originalSource:`{
  render: () => html\`
    <article class="prose" style="padding:24px">
      <div class="callout">
        <p>Untoned: an aside the reader can take or leave.</p>
...
}`,...a.parameters?.docs?.source},description:{story:`The margin variant. Genuinely an aside, so it goes beside the column rather
than interrupting it — and folds back into the flow when the viewport has no
room beside the text. Widen the preview past 1100px to see it move out.`,...a.parameters?.docs?.description}}}})))()}s();export{a as MarginNote,i as Tones,o as __namedExportsOrder,r as default};