import{n as e}from"./rolldown-runtime-DkW27tQK.js";import{o as t,s as n}from"./iframe-fR7HCL7S.js";var r,i,a,o;function s(){return(s=e((()=>{n(),r={title:`Components/Prose`,parameters:{docs:{description:{component:"Rendered markdown — a README, a design note, a skill description. The one place in the system where headings are a reading hierarchy rather than labels on bands of rows, so it restates them. It sits in the component layer, which is after layout, so `.prose h2` wins over `.doc h2` without either knowing about the other."}}}},i={render:()=>t`
    ...
    </article>`},o=[`Readme`,`Checklist`],i.parameters={...i.parameters,docs:{...i.parameters?.docs,source:{originalSource:`{
  render: () => html\`
    <div class="doc"><div class="main"><main class="content">
      <div class="symbol-head">
        <h1><span class="chip tone-slate">document</span>php-ai-toolkit</h1>
...
}`,...a.parameters?.docs?.source},description:{story:`A README written as a checklist, which markdown renders as list items with
 checkboxes.`,...a.parameters?.docs?.description}}}})))()}s();export{a as Checklist,i as Readme,o as __namedExportsOrder,r as default};