import{n as e}from"./rolldown-runtime-DkW27tQK.js";import{o as t,s as n}from"./iframe-fR7HCL7S.js";var r,i,a,o;function s(){return(s=e((()=>{n(),r={title:`Components/Meter`,parameters:{docs:{description:{component:`How a whole divides, at a glance, with the parts reachable. The bar is the shape of the answer and the legend is the answer; neither works alone.`}}}},i={render:()=>t`
    ...
    </div>`},o=[`Coverage`,`TinySegments`],i.parameters={...i.parameters,docs:{...i.parameters?.docs,source:{originalSource:`{
  render: () => html\`
    <div class="doc"><div class="main"><main class="content">
      <h2>How far the analysis got</h2>
      <div class="meter">
...
}`,...a.parameters?.docs?.source},description:{story:`A part that is one item out of nine hundred still has to be clickable, and
is exactly the category a reader is surprised by — so every segment keeps a
minimum width rather than rounding to nothing.`,...a.parameters?.docs?.description}}}})))()}s();export{i as Coverage,a as TinySegments,o as __namedExportsOrder,r as default};