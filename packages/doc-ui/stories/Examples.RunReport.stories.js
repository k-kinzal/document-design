...
export default {
  ...
  parameters: {
    docs: {
      description: {
        component:
          "QuuuAI's task report, rebuilt on this stylesheet. The default is an " +
          "English translation; the Japanese variant preserves the original. Same report, same " +
...
/** English translation of the supplied report; measurements are unchanged. */
export const Report = {
  render: () => html`
${drawDefs}
<article class="sheet" lang="en">
  ...
  <div class="hero">
    <div class="was">
      ...
      <span class="unit">Sources 20/29 · Gate 68</span>
    </div>
    <div class="mid">
    ...
    <div class="now">
      ...
      <span class="unit">Sources 29/30 · Gate 96 · Honest ceiling</span>
    </div>
  </div>
  ...
  <section class="sec">
    <div class="rail">
      ...
      <p class="sidenote"><span class="sidenote-label">Source</span>The bison 3.8.2 manual, retrieved on 2026-02-11. Later versions were not reviewed.</p>
    </div>
    <div class="field">
      <p class="lead">Nine gaps: link, test, or leave empty. Do not force 100.</p>
      <p class="note">Nine of 29 source units were empty. <a class="ref" href="#fig-holes">Figure 1</a> shows the breakdown: seven can be linked by adding IDs to existing scenarios.</p>
    </div>
    <figure class="plate plate-full diagram" id="fig-holes"><div class="compare compare-draw">
        ...
        <text x="140" y="182" text-anchor="middle" class="draw-note">The reader handles them</text>
        <text x="140" y="204" text-anchor="middle" class="draw-note">Specifications omit them</text>
        ...
        <text x="412" y="114" text-anchor="middle" class="draw-accent">Existing scenarios</text>
        ...
        <text x="618" y="114" text-anchor="middle" class="draw-accent">New scenario</text>
        ...
        <text x="748" y="82" class="draw-warn">Intro</text>
        <text x="706" y="114" text-anchor="middle" class="draw-warn">Left empty</text>
        <text x="706" y="132" text-anchor="middle" class="draw-warn">No behaviour</text>
        <path class="draw-guide" d="M304 160H748"/>
        <rect class="draw-box" x="304" y="176" width="200" height="76" rx="8"/>
        <text x="404" y="208" text-anchor="middle">26 supported</text>
        <text x="404" y="230" text-anchor="middle" class="draw-note">3 justified exclusions</text>
        <rect class="draw-box-open" x="520" y="176" width="112" height="76" rx="8"/>
        <text x="576" y="208" text-anchor="middle" class="draw-warn">1 uncovered</text>
        <text x="576" y="230" text-anchor="middle" class="draw-warn">No inflation</text>
        ...
        <text x="704" y="230" text-anchor="middle" class="draw-accent">+1 example</text>
          </svg></div>
        </div>
      </div>
      <figcaption>Where the nine source units went. Link seven to existing scenarios, add one scenario, and leave the introductory unit empty.<span class="plate-source">bison-parser 3.8.2 · symbols.yaml / rules.yaml snapshot</span></figcaption>
    </figure>
    <p class="caveat">Link the three terminal forms, definitions, spellings, nonterminals, two example fragments, and ordinary actions to existing Behat scenarios. Add a scenario only for character sets. The “grammatical classifications” introduction does not become a specification.</p>
  </section>
  ...
  <section class="sec">
    ...
    <figure class="plate plate-full diagram" id="fig-scale"><div class="draw-wrap"><svg class="draw" style="--dd-draw-width:820px" viewBox="0 0 820 220" role="img" aria-label="A scale from 0 to 100. Before: 68.97. Honest ceiling: 96.67. The hatched end rules out reaching 100 by relabelling gaps as unsupported.">
        ...
        <text x="400" y="120" text-anchor="middle" class="draw-note">Coverage %</text>
        <text x="780" y="120" text-anchor="end" class="draw-warn">100</text>
        <text x="780" y="140" text-anchor="end" class="draw-warn">Do not relabel gaps</text>
        ...
        <text x="360" y="184" text-anchor="middle" class="draw-accent">26 supported</text>
        <text x="718" y="184" text-anchor="middle" class="draw-note">3 excluded</text>
        <text x="767" y="212" text-anchor="middle" class="draw-warn">1 empty</text>
        <text x="40" y="212" class="draw-note">30 source units</text>
      </svg></div>
      <figcaption>Coverage scale. The honest ceiling is 96.67; relabelling gaps as unsupported does not justify 100.<span class="plate-source">Gate 96 · bison-parser 3.8.2</span></figcaption>
    </figure>
    <div class="figures">
      <figure>
        <svg class="draw" style="--dd-draw-width:240px" viewBox="0 0 240 96" role="img" aria-label="Count supported units and justified exclusions together.">
          ...
          <text x="55" y="54" text-anchor="middle" class="draw-label">Supported</text>
          <text x="155" y="54" text-anchor="middle" class="draw-note">Excluded</text>
          <path class="draw-line tone-accent" d="M208 42H232M208 54H232"/>
        </svg>
        <h3>Counted units</h3>
        <p>Units with an interpretation: verified support plus justified exclusions.</p>
      </figure>
      <figure>
        <svg class="draw" style="--dd-draw-width:240px" viewBox="0 0 240 96" role="img" aria-label="Empty units stay visible. Do not turn them into hatched exclusions.">
          <rect class="draw-box-open" x="6" y="28" width="76" height="40" rx="8"/>
          <text x="44" y="54" text-anchor="middle" class="draw-warn">Empty</text>
        ...
        <h3>Keep gaps visible</h3>
        <p>The introduction stays empty. Do not hide it behind an unsupported label.</p>
      </figure>
      <figure>
        <svg class="draw" style="--dd-draw-width:240px" viewBox="0 0 240 96" role="img" aria-label="The three exclusions remain the generated parser, scanner, and character-set runtime.">
          ...
          <text x="202" y="54" text-anchor="middle" class="draw-note">Encoding</text>
        </svg>
        <h3>Runtime exclusions</h3>
        <p><code>BISON-RUNTIME-001–003</code> stay unchanged, outside the reader.</p>
      </figure>
    </div>
  </section>

  <section class="sec">
    <div class="label">03<br>Process</div>
    <div class="field">
      <p class="lead">Connect sources, specifications, and Behat. Leave the parser unchanged.</p>
    </div>
    <figure class="plate plate-full diagram" id="fig-chain"><div class="compare compare-draw">
        <div class="was"><span class="cap">Before</span>
        ...
        <text x="108" y="92" text-anchor="middle">Source</text>
        ...
        <text x="196" y="160" text-anchor="middle" class="draw-note">Missing spec</text>
        <text x="196" y="204" text-anchor="middle" class="draw-note">Production code and features unchanged</text>
          </svg></div>
        </div>
        <div class="now"><span class="cap">After</span>
        ...
        <text x="460" y="92" text-anchor="middle">Source</text>
        ...
        <text x="600" y="92" text-anchor="middle">Spec</text>
        ...
        <text x="460" y="160" text-anchor="middle" class="draw-warn">Intro</text>
        <path class="draw-line-open draw-arrow" d="M512 154H548"/>
        <rect class="draw-box" x="556" y="132" width="216" height="44" rx="8"/>
        <text x="664" y="160" text-anchor="middle" class="draw-note">Parser source unchanged</text>
        <text x="594" y="204" text-anchor="middle" class="draw-accent">Add example to the Symbols selector</text>
          </svg></div>
        </div>
      </div>
      <figcaption>Sources link to specifications, then to Behat. Only the introduction stays outside the specifications; the production parser remains out of scope.<span class="plate-source">Three exclusions outside the reader: BISON-RUNTIME-001–003</span></figcaption>
    </figure>
    <div class="figures">
      <figure>
        <svg class="draw" style="--dd-draw-width:240px" viewBox="0 0 240 96" role="img" aria-label="A solid line connects the source box to the specification box.">
        ...
        <h3>Link</h3>
        <p>Add IDs to existing scenarios in <code>symbols.yaml</code> / <code>rules.yaml</code>.</p>
      </figure>
      <figure>
        <svg class="draw" style="--dd-draw-width:240px" viewBox="0 0 240 96" role="img" aria-label="Add one box, then connect it.">
        ...
        <h3>Test</h3>
        <p>Add a scenario to <code>symbols.feature</code> only for character sets.</p>
      </figure>
      <figure>
        <svg class="draw" style="--dd-draw-width:240px" viewBox="0 0 240 96" role="img" aria-label="The dotted box stays outside the specification; excluded boxes are hatched.">
        ...
        <h3>Leave</h3>
        <p>Record the reason in the README. Raise the gate to 96 and require no more.</p>
      </figure>
    </div>
  </section>
  ...
  <section class="sec">
    ...
    <div class="field">
      <p class="lead">Local checks passed. The working directory remains clean.</p>
    </div>
    <div class="stats">
      <div class="stat"><b class="stat-fig">16/16</b><span class="stat-label">Diff coverage of changed units. 23 lint checks and 307 Behat scenarios passed locally.</span></div>
      <div class="stat"><b class="stat-fig">6</b><span class="stat-label">Files: baseline, gate, README, two definitions, and one feature. No parser source changes.</span></div>
      <div class="stat"><b class="stat-fig">393</b><span class="stat-label">Pull request. Fetch was denied, so the GitHub Git data API created a commit with the same six files on top of main.</span></div>
      <div class="stat"><b class="stat-fig">0</b><span class="stat-label">Working-directory changes. The starting and ending trees are identical. Changes live in the worktree and pull request.</span></div>
    </div>
    <p class="caveat">CI was pending when this report was created; success was not confirmed in this run. An empty blob upload was retried with a JSON body. An autoload path error in the throwaway environment is not part of the deliverable. The local worktree still uses the old base corresponding to PR #380. Fetch and align it with the remote before continuing.</p>
  </section>
</article>`,
};

/** The original Japanese report, for Japanese typography and figure numbering. */
...
<article class="sheet" lang="ja">
  ...
  <section class="sec">
    ...
    <div class="field">
      ...
      <p class="note">出典 29 単位のうち 9 が空だった。内訳は <a class="ref" href="#ja-fig-holes">図 1</a> のとおりで、7 は既存シナリオに ID を付けるだけで結べる。</p>
    </div>
    <figure class="plate plate-full diagram" id="ja-fig-holes"><div class="compare compare-draw">
  ...
  <section class="sec">
    ...
    <figure class="plate plate-full diagram" id="ja-fig-scale"><div class="draw-wrap"><svg class="draw" style="--dd-draw-width:820px" viewBox="0 0 820 220" role="img" aria-label="0から100の尺。68.97が変更前。96.67が正直な上限。100は斜線で封じ、unsupportedへの付け替えをしない。">
        <line class="draw-line" x1="40" y1="88" x2="780" y2="88"/>
        <circle class="plot-point tone-neutral" cx="40" cy="88" r="4"/>
        <circle class="draw-box-alt tone-danger" cx="780" cy="88" r="4"/>
        <path class="draw-line tone-danger" d="M768 76L792 100M792 76L768 100"/>
  ...
  <section class="sec">
    ...
    <figure class="plate plate-full diagram" id="ja-fig-chain"><div class="compare compare-draw">
