    ...
    docs: {
      description: {
        component:
          ...
          "**The markup ships no `hidden`.** Every panel is visible and carries " +
          "its own heading; the script hides the inactive ones on start. Turn " +
          "JavaScript off and this is three headed sections — which is also " +
          "what prints, since the tab strip that labelled them is not printed.\n\n" +
...
/**
 * The same markup with the behaviour layer absent: three headed sections, all
 * readable, nothing lost. This is what an archived copy without its script
 * looks like, and what the printer receives.
 */
export const WithoutScript = {
  render: () => html`
    <div class="doc"><div class="main"><main class="content" style="max-width:720px">
      <h2>The statement</h2>
      <div class="tabs">
